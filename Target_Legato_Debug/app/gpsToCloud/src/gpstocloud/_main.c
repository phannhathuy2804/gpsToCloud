...
// Startup code for the executable 'gpstocloud'.
...
LE_SHARED const char* _sensorsComponent_le_adc_ServiceInstanceName = "gpstocloud.sensorsComponent.le_adc";
LE_SHARED const char* _gpsToCloudComponent_le_pos_ServiceInstanceName = "gpstocloud.gpsToCloudComponent.le_pos";
LE_SHARED const char* _gpsToCloudComponent_le_posCtrl_ServiceInstanceName = "gpstocloud.gpsToCloudComponent.le_posCtrl";
LE_SHARED const char* _gpsToCloudComponent_le_avdata_ServiceInstanceName = "gpstocloud.gpsToCloudComponent.le_avdata";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t gpstocloud_exe_LogSession;
LE_SHARED le_log_Level_t* gpstocloud_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    gpstocloud_exe_LogSession = log_RegComponent("gpstocloud_exe", &gpstocloud_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_sensorsComponent.so");
    LoadLib("libComponent_gpsToCloudComponent.so");
